import { getProjectionMatrix, Matrix4x4Utils, packedHSL2HSL } from "../3d/utils";
...
export function init(canvas: RenderCanvas, models: OB3[] | OB3, vertexShaderSource: string, fragmentShaderSource: string) {
	...
	canvas.gvContext = { gl, ext, models, shaderProgram };
