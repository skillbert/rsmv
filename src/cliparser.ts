...
const FileRangeArgument: cmdts.Type<string, FileRange[]> = {
...
export var filerange = literal({
	files: cmdts.option({ long: "ids", short: "i", type: FileRangeArgument, defaultValue: () => [{ start: [0, 0, 0], end: [Infinity, Infinity, Infinity] }] as FileRange[] })
});
